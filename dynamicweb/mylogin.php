...
if (isset($_GET['who']) && isset($_GET['pass'])) {
    ...
    $sql = "SELECT * FROM student WHERE stdid = '$studentId' AND stdname = '$password'";
    echo $sql;
    ...
    if ($row) {
        ...
        $failure = "Incorrect student ID or password";
    }
}
?>
...
<body>
    ...
    <div class="content">
        <h2>Login as Student in www.anumathew.com with ID and PASSWORD</h2>

...
if (isset($_POST["submit"])) {
    ...
    $stdname = $_POST['myName'];
    $branch = $_POST['mybranch'];
    $batch = $_POST['mybatch'];
    $age = $_POST['myage'];
    $myid=$_POST["myid"];
    $sql = "UPDATE student SET stdname='$stdname',
    branch='$branch',batch='$batch',age=$age WHERE stdid=$myid";
...
if (mysqli_num_rows($result) > 0) {
  ...
  echo "<table align='center' border='border' width='600'
   cellpadding='10'>
